...
$pdCmimiVals = array_values(array_unique(array_map(fn($v) => priceFmt($v), $db->query("SELECT DISTINCT cmimi FROM plini_depo WHERE cmimi IS NOT NULL ORDER BY cmimi")->fetchAll(PDO::FETCH_COLUMN))));
    ...
    <div class="card-body padded">
        <form class="ajax-form" action="/api/insert.php" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label>Çmimi</label>
                    <input type="number" name="cmimi" step="0.0001" id="pd_cmimi">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
            ...
            <table class="data-table" data-table="plini_depo" data-server-sort="true">
                ...
                <tbody>
                    ...
                    <tr data-id="<?= $r['id'] ?>">
                        ...
                        <td class="num editable" data-field="cmimi" data-type="number" data-step="0.0001"><?= priceFmt($r['cmimi']) ?></td>
