            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th class="num server-sort" onclick="clientSortColumn(this, 1)" style="cursor:pointer;user-select:none;" data-filter="f_lit_blera" data-filter-values="<?= e(json_encode($litBleraVals)) ?>" data-filter-mode="client" data-filter-col="1">Litra te blera per muaj <i class="fas fa-sort"></i></th>
                        <th class="num server-sort" onclick="clientSortColumn(this, 2)" style="cursor:pointer;user-select:none;" data-filter="f_lit_shitura" data-filter-values="<?= e(json_encode($litShituraVals)) ?>" data-filter-mode="client" data-filter-col="2">Litra te shitura per muaj <i class="fas fa-sort"></i></th>
                        <th class="num server-sort" onclick="clientSortColumn(this, 3)" style="cursor:pointer;user-select:none;" data-filter="f_lit_bleramefat" data-filter-values="<?= e(json_encode($litBleraMeFatVals)) ?>" data-filter-mode="client" data-filter-col="3">Litra blera me faturë <i class="fas fa-sort"></i></th>
                        <th class="num server-sort" onclick="clientSortColumn(this, 4)" style="cursor:pointer;user-select:none;" data-filter="f_lit_faturuara" data-filter-values="<?= e(json_encode($litFaturuaraVals)) ?>" data-filter-mode="client" data-filter-col="4">Litra lëshuar me faturë <i class="fas fa-sort"></i></th>
                        <th class="num server-sort" onclick="clientSortColumn(this, 5)" style="cursor:pointer;user-select:none;" data-filter="f_lit_mbetur" data-filter-values="<?= e(json_encode($litMbeturVals)) ?>" data-filter-mode="client" data-filter-col="5">Litra mbetur me faturë <i class="fas fa-sort"></i></th>
                        <th class="num server-sort" onclick="clientSortColumn(this, 6)" style="cursor:pointer;user-select:none;" data-filter="f_lit_disp" data-filter-values="<?= e(json_encode($litDispVals)) ?>" data-filter-mode="client" data-filter-col="6">Litrat ne dispozicion <i class="fas fa-sort"></i></th>
                        <th class="num server-sort" onclick="clientSortColumn(this, 7)" style="cursor:pointer;user-select:none;" data-filter="f_lit_boca" data-filter-values="<?= e(json_encode($litBocaVals)) ?>" data-filter-mode="client" data-filter-col="7">Boca te shpërndara <i class="fas fa-sort"></i></th>
                        <th class="num server-sort" onclick="clientSortColumn(this, 8)" style="cursor:pointer;user-select:none;" data-filter="f_lit_shitje" data-filter-values="<?= e(json_encode($litShitjeVals)) ?>" data-filter-mode="client" data-filter-col="8">Shitje totale per muaj <i class="fas fa-sort"></i></th>
                        <th class="num server-sort" onclick="clientSortColumn(this, 9)" style="cursor:pointer;user-select:none;" data-filter="f_lit_kthim" data-filter-values="<?= e(json_encode($litKthimVals)) ?>" data-filter-mode="client" data-filter-col="9">Kthim litrave per bocë <i class="fas fa-sort"></i></th>
                    </tr>
                </thead>
                <tbody>
